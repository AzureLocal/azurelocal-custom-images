# azurelocal-custom-images — Claude Code Context
...
- `azurelocal-custom-images-engineer` (model: sonnet) — Expert in `azurelocal-custom-images`: deep knowledge of this repo's structure, conventions, and development workflow.
