...
Thank you for your interest in contributing to **azurelocal-custom-images**.
...
This project follows the org-wide AzureLocal standards at [azurelocal.cloud/standards](https://azurelocal.cloud/standards/).
